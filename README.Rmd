...
#### Regression analysis:
* `tidy_lm_results`: Comprehensive function for running multiple regression specifications
...
For more documentation, see the vignettes or add a `?` before any function (e.g., `?PaluckTools::tidy_lm_results`).
