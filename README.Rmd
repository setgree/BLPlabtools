...
- **Datasets**:
  ...
  - `map_reduction_data` - Meat/animal product reduction meta-analysis (included for demonstrating the `make_bib()` function; lead author Seth Green is a Paluck Lab affiliate)
