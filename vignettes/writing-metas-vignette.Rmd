...
To use this function, you need a column of DOIs in your meta-analytic database. Neither `contact_data` nor `sv_data` has DOI information, but the `map_reduction_data` dataset does. This dataset comes from a meta-analysis of interventions to reduce consumption of meat and animal products (Green et al., 2025) and is included in this package specifically to demonstrate the `make_bib()` function.
