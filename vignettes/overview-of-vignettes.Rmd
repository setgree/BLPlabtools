...
## 1 BLP_lab_tools supports two research workflows.

BLP_lab_tools provides functions for two types of analysis:
...
## 3 Vignettes 1-3 focus on steps 4-6 (the data analysis portion).
...
## 4 Vignette 4 covers experimental analysis and table formatting.
